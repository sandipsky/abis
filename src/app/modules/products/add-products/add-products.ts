...
@Component({
  ...
  imports: [CommonModule, MatIconModule, MatDialogModule, FormsModule, ReactiveFormsModule, NgSelectModule, MatStepperModule, AmountPipe],
...
export class AddProductsComponent {
  ...
  ngOnInit() {
    ...
    if (this.data?.formData?.id) {
      ...
      this.configService.configuration$.subscribe((c) => {
